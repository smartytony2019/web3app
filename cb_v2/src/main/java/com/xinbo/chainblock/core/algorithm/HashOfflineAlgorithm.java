 ...
 */
@Component
public class HashOfflineAlgorithm {
     ...
     * @return
     */
    private AlgorithmResult hashComb(HashResultEntity hashResult, HashOfflineBetEntity bet) {
        AlgorithmResult ar = AlgorithmResult.builder().status(AlgorithmCode.LOST).build();

        String content = "";
        int moneyAmount = bet.getMoney().intValue();
        String str = String.valueOf(moneyAmount);
        String endVal = str.substring(str.length() - 1);
        if(endVal.equals("1")) {
            content = "小";
        }
     ...
     * @return
     */
    private AlgorithmResult hashBjl(HashResultEntity hashResult, HashOfflineBetEntity bet) {
        AlgorithmResult ar = AlgorithmResult.builder().status(AlgorithmCode.LOST).build();
...
//        String content = bet.getContentZh();
     ...
     * @return
     */
    private AlgorithmResult luckyHash(HashResultEntity hashResult, HashOfflineBetEntity bet) {
        AlgorithmResult ar = AlgorithmResult.builder().status(AlgorithmCode.LOST).build();
     ...
     * @return
     */
    private AlgorithmResult hashBull(HashResultEntity hashResult, HashOfflineBetEntity bet) {
        AlgorithmResult ar = AlgorithmResult.builder().status(AlgorithmCode.LOST).build();
